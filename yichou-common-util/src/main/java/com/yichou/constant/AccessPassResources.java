...
public class AccessPassResources {
    ...
    static {
        ...
        PASS_RES_SET.add("/member/auth/do/logout");
        PASS_RES_SET.add("/member/auth/do/login");
        PASS_RES_SET.add("/member/auth/do/register");
        PASS_RES_SET.add("/member/auth/send/short/message.json");
        //PASS_RES_SET.add("/member/auth/to/center/page");
    }
